...
export class PromotionInfraestructureResponseDTO {
...
export class FindAllPromotionInfraestructureResponseDTO {
    @ApiProperty({ type: [PromotionInfraestructureResponseDTO] })
    promotions: PromotionInfraestructureResponseDTO[];
}
