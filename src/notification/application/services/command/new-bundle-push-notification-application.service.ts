...
export class AddNewBundleApplicationService extends IApplicationService<NewProductPushNotificationApplicationRequestDTO,NewProductPushNotificationApplicationResponseDTO>{
    constructor(
